...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($event_title) || empty($event_date) || empty($start_time) || empty($end_time) || empty($location) || $required_volunteers <= 0) {
        ...
        if (empty($error_msg)) {
            ...
            if ($stmt) {
                mysqli_stmt_bind_param($stmt, "issssssiss", $ds_id, $event_title, $description, $event_date, $start_time, $end_time, $location, $required_volunteers, $image_path, $verification_token);
...
<head>
    ...
    <style>
        ...
        input:focus, textarea:focus { border-color: #0d47a1; outline: none; box-shadow: 0 0 5px rgba(13, 71, 161, 0.2); }
