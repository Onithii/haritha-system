...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action'])) {
    ...
    if ($_POST['action'] === 'register') {
        ...
        if ($already_in) {
            $_SESSION['flash_msg'] = "ℹ️ You are already registered for this event. See you there!";
            $_SESSION['flash_class'] = "alert-info";
        } elseif (!isset($_POST['accept_terms'])) {
            $_SESSION['flash_msg'] = "⚠️ You must read and agree to the Liability Waiver and Terms before registering.";
            ...
            if ($current_volunteers >= (int)$event['required_volunteers']) {
                $_SESSION['flash_msg'] = "🚫 Sorry, this event has already reached its maximum volunteer capacity!";
                $_SESSION['flash_class'] = "alert-error";
            } else {
                ...
                if ($stmt) {
                    ...
                    if (mysqli_stmt_execute($stmt)) {
                        $_SESSION['flash_msg'] = "🎉 Thank you! You have successfully registered as a volunteer for this campaign.";
